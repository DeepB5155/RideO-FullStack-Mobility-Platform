...
{
    /// <inheritdoc />
    public partial class AddCarpoolingArchitecture : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StopName = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    StopOrder = table.Column<int>(type: "integer", nullable: false),
                    PriceFromStart = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RouteId = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    PickupStopId = table.Column<Guid>(type: "uuid", nullable: false),
                    DropoffStopId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_RouteStops_DropoffStopId",
                        column: x => x.DropoffStopId,
                        principalTable: "RouteStops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bookings_RouteStops_PickupStopId",
