      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.instruction}>
            Did you have a bad experience with a passenger? Please describe the issue below.
          </Text>

          <Text style={styles.label}>Subject</Text>
          <TextInput
            style={styles.input}
            placeholder="e.g. Passenger refused to pay"
...
const styles = StyleSheet.create({
  ...
  input: {
    width: '100%',
    backgroundColor: '#1E293B', // driver theme dark input
    borderWidth: 1,
