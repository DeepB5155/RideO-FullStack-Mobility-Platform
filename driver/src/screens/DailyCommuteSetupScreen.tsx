...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 20, paddingTop: 60, backgroundColor: theme.colors.background },
  ...
  progressContainer: { paddingHorizontal: 20, paddingBottom: 20, backgroundColor: theme.colors.background },
  ...
  input: { backgroundColor: theme.colors.surface, borderRadius: theme.radius.md, padding: 16, fontSize: 16, color: theme.colors.text.main, borderWidth: 1, borderColor: theme.colors.border },
  suggestionsCard: { backgroundColor: theme.colors.card, borderRadius: theme.radius.md, marginTop: 5, padding: 10, ...theme.shadows.medium, maxHeight: 200, borderWidth: 1, borderColor: theme.colors.border },
  ...
  dayTextActive: { color: theme.colors.text.main },
  rowGroup: { flexDirection: 'row', justifyContent: 'space-between', gap: 15, marginBottom: 25, marginTop: 15 },
  halfWidth: { flex: 1 },
  stepperContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: theme.colors.surface, borderRadius: theme.radius.md, borderWidth: 1, borderColor: theme.colors.border, overflow: 'hidden' },
  ...
  switchGroup: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: theme.colors.surface, padding: 15, borderRadius: theme.radius.md, marginBottom: 15, borderWidth: 1, borderColor: theme.colors.border },
  ...
  nextBtn: { backgroundColor: theme.colors.primary, padding: theme.spacing.md, borderRadius: theme.radius.lg, alignItems: 'center', marginTop: 30, ...theme.shadows.small },
  nextBtnText: { color: theme.colors.text.main, fontSize: 18, fontWeight: 'bold' },
  summaryCard: { backgroundColor: theme.colors.card, borderRadius: theme.radius.xl, padding: 20, ...theme.shadows.medium, marginBottom: 25, borderWidth: 1, borderColor: theme.colors.border },
  ...
  publishBtn: { backgroundColor: theme.colors.success, padding: theme.spacing.md, borderRadius: theme.radius.lg, alignItems: 'center', marginBottom: 15, ...theme.shadows.small },
  publishBtnText: { color: theme.colors.text.main, fontSize: 18, fontWeight: 'bold' },
  draftBtn: { backgroundColor: theme.colors.surface, padding: theme.spacing.md, borderRadius: theme.radius.lg, alignItems: 'center', borderWidth: 1, borderColor: theme.colors.border },
  ...
  primaryBtn: { backgroundColor: theme.colors.primary, padding: theme.spacing.md, borderRadius: theme.radius.lg, alignItems: 'center', width: '100%', ...theme.shadows.small },
  primaryBtnText: { color: theme.colors.text.main, fontSize: 16, fontWeight: 'bold' }
});
